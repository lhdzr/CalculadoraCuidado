                                   ...
                                   tabPanel("Tiempo de cuidado",
                                            ...
                                            flowLayout(numericInput("p5.1",
                                                       ...
                                                       numericInput("p5.9",
                                                                    ...
                                                                    value=10),
                                                       numericInput("p5.10 ESTE SE REPITE",
                                                                    "Recoger o esperar a algún adulto mayor para que recibiera atención de salud",
                                                                    value=10),
                                                       numericInput("p5.11",
                                                                    "Dar terapia especial o ayudar a realizar ejercicios a algún adulto mayor",
                                                                    value=10),
                                                       numericInput("p5.12 SE REPITE",
                                                                    "Llevar y/o recoger de clases, trabajo u otro lugar a algún adulto mayor",
                                                                    value=10),
                                                       numericInput("p5.13",
                                         ...
                                         tabPanel("Tiempo de cuidado",
                                                  ...
                                                  flowLayout(numericInput("p3.1",
                                                             ...
                                                             numericInput("p3.9",
                                                                          "Dar medicamentos o checar los síntomas de algún adulto mayor",
                                                                          value=10),
                                                             numericInput("p3.10 ESTE SE REPITE",
                                                                          "Recoger o esperar a algún adulto mayor para que recibiera atención de salud",
                                                                          value=10),
                                                             numericInput("p3.11",
                                                                          "Dar terapia especial o ayudar a realizar ejercicios a algún adulto mayor",
                                                                          value=10),
                                                             numericInput("p3.12 SE REPITE",
                                                                          "Llevar y/o recoger de clases, trabajo u otro lugar a algún adulto mayor",
                                                                          value=10),
                                                             numericInput("p3.13",
                                                                          "Ayudar o apoyar en el trabajo de algún adulto mayor",
