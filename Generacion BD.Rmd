...
```{r}
bd = enut %>%
  select(SEXO,EDAD,ESC,urbano,TIEMPO_TOTAL,P4_5,P6_9_3,P3_6,SAL_SEM,PAREN,TIEMPO_CHOF,TIEMPO_COCIN,TIEMPO_ENF_TEC,TIEMPO_FISIO,TIEMPO_CUID) %>%
  rename(indigena=P4_5, programa_social=P6_9_3, seguro_medico=P3_6)#%>%
...
###Modelos
```{r}
lm(SAL_SEM~.-TIEMPO_TOTAL-TIEMPO_CHOF-TIEMPO_FISIO-TIEMPO_ENF_TEC-TIEMPO_COCIN,data=bd)
```
...
#### Guardar bases
```{r}
##write.csv(enut,"products/csv/enut.csv")
```
