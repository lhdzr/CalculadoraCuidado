...
```{r}
bd = enut %>%
  select(SEXO,EDAD,ENT,ESC,urbano,TIEMPO_TOTAL,P4_4,P4_5,P5_5,P6_9_3,P3_6,PAREN,TIEMPO_CHOF,TIEMPO_COCIN,TIEMPO_ENF_TEC,TIEMPO_FISIO,TIEMPO_CUID,NUM_PER,SAL_SEM) %>%
